...
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports MOSI]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports MISO]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports CS_n]
